...
public class DoorMovement : MonoBehaviour
{
    ...
    [SerializeField]
    FrontDoorCollider frontDoorCollider; //"FrontDoorColllider" scirpt
    [SerializeField]
    BackDoorCollider backDoorCollider; //"BackDoorCollider" script
    ...
    public void GrabDoorCollision(bool playerHasCollided) //This will be called by the "BackDoorCollider" script and the "FrontDoorColllider" scirpt
    {
        playerWantsToInteractWithDoor = playerHasCollided;
    }

    public void GrabPlayerPosition(Vector3 playerPos) //This will be called by the "BackDoorCollider" script and the "FrontDoorColllider" scirpt
    {
